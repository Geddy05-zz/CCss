...
namespace Simple_solutions.Matcher
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            processorType.Add(new SelectListItem { Text = "", Value = null });
            ...
            processorClockSpeed.Add(new SelectListItem { Text = "", Value = null });
            ...
            processorCores.Add(new SelectListItem { Text = "", Value = null });
            ...
            memorySlots.Add(new SelectListItem { Text = "", Value = null });
            ...
            memorySpeed.Add(new SelectListItem { Text = "", Value = null });
